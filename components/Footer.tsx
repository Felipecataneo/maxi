    ...
    <footer className="bg-gray-900 text-gray-300 py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Image src="/logo-white.png" alt="Maxi Institute" width={120} height={40} />
            <p className="mt-4">
              Empowering organizations with AI-powered customer intelligence solutions.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/solutions/retail" className="hover:text-white">Retail</Link></li>
              <li><Link href="/solutions/finance" className="hover:text-white">Finance</Link></li>
              <li><Link href="/solutions/healthcare" className="hover:text-white">Healthcare</Link></li>
              <li><Link href="/solutions/ecommerce" className="hover:text-white">E-commerce</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p>© 2025 Maxi Institute. All rights reserved.</p>
