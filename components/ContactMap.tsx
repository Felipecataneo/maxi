...
// This component doesn't need to be a client component unless you add interactivity here
// or animations that require hooks. The current animation (animate-fade-in) is pure CSS.
...
export default function ContactMap() {
  ...
  return (
    // Removed bg-section-background class from the section, it's now on the wrapper div in page.tsx
    // Added vertical padding here
    <section id="contact" className="py-16 md:py-24">
      <div className="container mx-auto px-4 text-center animate-fade-in"> {/* Add animation */}
        {/* Use font-heading and text-foreground */}
        <h2 className="text-3xl md:text-4xl text-foreground font-heading mb-8">ENTRE EM CONTATO</h2> {/* Ensure font-heading and foreground color */}
